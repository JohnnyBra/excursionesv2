...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row transition-colors duration-300">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white/60 dark:bg-black/20 backdrop-blur-md border-r border-gray-200 dark:border-white/10 h-screen sticky top-0 transition-colors duration-300">
