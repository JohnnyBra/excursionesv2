                            ...
                            {activeTab === 'details' && (
                                isEditing && user?.role !== UserRole.TESORERIA ? (
                                    ...
                                    <div className="space-y-6">
                                        <div className="flex justify-between items-start bg-gray-50 dark:bg-white/5 p-4 rounded-xl border border-white/10">
                                            <div className="space-y-2">
                                                <h3 className="text-xl font-bold text-gray-900 dark:text-white">{selectedExcursion.destination}</h3>
